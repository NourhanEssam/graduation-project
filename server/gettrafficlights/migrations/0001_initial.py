# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-01-25 18:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Intersection',
            fields=[
                ('Intersection_ID', models.CharField(max_length=10, primary_key=True, serialize=False)),
                ('MAC', models.CharField(default=b'0', max_length=12)),
                ('IP', models.CharField(default=b'0', max_length=8)),
            ],
        ),
        migrations.CreateModel(
