# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-06-17 00:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='CentralNode',
            fields=[
                ('CentralNode_ID', models.IntegerField(default=gettrafficlights.models.Central_Node_number, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Intersection',
            fields=[
                ('Intersection_ID', models.IntegerField(default=gettrafficlights.models.Intersection_number, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='TrafficLight',
            fields=[
                ('TL_ID', models.CharField(max_length=10, primary_key=True, serialize=False)),
